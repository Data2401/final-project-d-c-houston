...
Lets dive deeper into the housing market in each city as well as what an individual can expect when it comes to commute time to work.
...
San Antonio with a strong Hispanic presence. Over half of their population coming from Hispanic descent! Houston also matches diversity levels with San Antonio. Houston however, has the largest share of ethnicity inside its city limits. Lastly, Dallas will be the city with the least Hispanic presence. 
